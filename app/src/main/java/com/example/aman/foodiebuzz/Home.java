...
import com.example.aman.foodiebuzz.ViewHolder.MenuViewHolder;
...
public class Home extends AppCompatActivity
    ...
    private void loadMenu() {
        adapter=new FirebaseRecyclerAdapter<Category, MenuViewHolder>(Category.class,
                R.layout.menu_item,MenuViewHolder.class,categories) {
            @Override
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_menu) {
            Intent orderStatus=new Intent(Home.this,Home.class);
